...
class StandaloneMock:
    def __init__(self, serial_port: str,
        ...
        self.manager.connect(SerialSettings(port=serial_port, baudrate=serial_baudrate))
        self.setup_loggers()
        ...
        self._logger.info(
            f'Standalone mock is running on port {serial_port} with baudrate {serial_baudrate}')
...
if __name__ == "__main__":
    ...
    parser.add_argument('--feed_interval', default=0)
    ...
    standalone_mock = StandaloneMock(cl_args.serial_port,
                                     cl_args.serial_baudrate,
